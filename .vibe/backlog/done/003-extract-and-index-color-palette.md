...
## Acceptance Criteria
- [x] System returns an indexed list of the distinct colors found in the image
- [x] Near-identical colors caused by compression artifacts are not counted as separate palette entries
- [x] System reports the total number of distinct colors found
