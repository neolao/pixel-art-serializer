...
// which mis-ranks blues/greens and near-greys. Ported from the research
// spike in spikes/011-grid-and-palette-algorithms/color.mjs
// (see .vibe/decisions/002-grid-and-palette-algorithms.md).

export type Lab = readonly [number, number, number];

const D65 = { x: 95.047, y: 100.0, z: 108.883 };

export function rgbToLab([r, g, b]: readonly [number, number, number]): Lab {
